...
let header = createElement("h1","id","title", null, null, "Pagination");

// for pagination

pagination = createElement("div", "class", "pagination");
innerDiv = createElement("div", "class", "d-flex justify-content-center text-center", "id", "buttons");
...
let a_previous = createElement("a", "class","page-link", "id","Previous","Previous");
...
let table = createElement( "table",  "class","table table-bordered center", "id","table");
...
container.append(header, pagination, tableDiv);
